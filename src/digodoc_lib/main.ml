...
let main () =
  ...
  in
  let arg_set_frontend_type ft =
    EZCMD.TYPES.Arg.Unit (fun () -> frontend := ft)
  in
  ...
  EZCMD.parse EZCMD.TYPES.[
      ...
      "--api-index", arg_set_frontend_type JS_API,
      "call api for generate dynamic index pages";

      "--js-ocaml", arg_set_frontend_type JS_OCAML,
      "use frontend generated by js_of_ocaml";
